...
with(this){return _c('p',[_v("The "),_c('strong',[_v("API")]),_v(" of this component is specified in "),_c('a',{attrs:{"href":"https://github.com/AY2324S2-CS2103T-T14-1/tp/blob/master/src/main/java/seedu/address/ui/Ui.java"}},[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Ui.java")])])])}
},function anonymous(
) {
...
with(this){return _c('p',[_c('strong',[_v("API")]),_v(" : "),_c('a',{attrs:{"href":"https://github.com/AY2324S2-CS2103T-T14-1/tp/blob/master/src/main/java/seedu/address/logic/Logic.java"}},[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Logic.java")])])])}
},function anonymous(
) {
...
with(this){return _c('p',[_c('strong',[_v("API")]),_v(" : "),_c('a',{attrs:{"href":"https://github.com/AY2324S2-CS2103T-T14-1/tp/blob/master/src/main/java/seedu/address/model/Model.java"}},[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Model.java")])])])}
},function anonymous(
) {
...
with(this){return _c('p',[_c('strong',[_v("API")]),_v(" : "),_c('a',{attrs:{"href":"https://github.com/AY2324S2-CS2103T-T14-1/tp/blob/master/src/main/java/seedu/address/storage/Storage.java"}},[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Storage.java")])])])}
},function anonymous(
) {
...
with(this){return _c('h3',{attrs:{"id":"implemented-assign-task-feature"}},[_v("[Implemented] Assign task feature"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#implemented-assign-task-feature","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
...
with(this){return _c('p',[_v("The implemented assign task mechanism is facilitated by "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("AddressBook")]),_v(".")])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("AddressBook#UniquePersonList")]),_v(": Represents the list of persons stored in the address book.")]),_v(" "),_c('li',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("AddressBook#UniqueTaskList")]),_v(": Represents the list of tasks assigned within the address book.")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("Ui")]),_v(" "),_c('ul',[_c('li',[_v("The user executes the command "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("assign task/Proposal by/20-05-2024 2359 to/2")]),_v(" to assign a task named \"Proposal\" with a specified deadline to the 2nd person in the address book.")])])]),_v(" "),_c('li',[_c('p',[_v("Parser")]),_v(" "),_c('ul',[_c('li',[_v("The input command is parsed by the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("AddressBookParser")]),_v(" component.")]),_v(" "),_c('li',[_v("The "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("assign")]),_v(" command keyword triggers the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("AssignTaskCommandParser")]),_v(" to extract task details (name, deadline) and the index of the person to assign the task to.")]),_v(" "),_c('li',[_v("By parsing in "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("AssignTaskCommandParser")]),_v(", a "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Task")]),_v(" object is created to encapsulate the task details and returns an "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("AssignTaskCommand")]),_v(" object representing the command to assign the task.")])])]),_v(" "),_c('li',[_c('p',[_v("Logic execution")]),_v(" "),_c('ul',[_c('li',[_v("The Command object - "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("AssignTaskCommand")]),_v(" is executed in the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("LogicManager")]),_v(".")]),_v(" "),_c('li',[_v("The "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("AssignTaskCommand")]),_v(" invokes the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("assignTask")]),_v(" method in the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Model")]),_v(" component.")])])])])}
},function anonymous(
) {
with(this){return _c('p',[_v("The following sequence diagram shows how an assign task operation goes through the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Logic")]),_v(" component:")])}
},function anonymous(
) {
with(this){return _c('ol',{attrs:{"start":"3"}},[_c('li',[_v("Model operation\n"),_c('ul',[_c('li',[_v("The "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("model#assignTask")]),_v(" internally triggers the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("AddressBook#assignTask")]),_v(" to:\n"),_c('ul',[_c('li',[_v("a. The "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Task")]),_v(" is added to the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("UniqueTaskList")]),_v(" in the address book.")]),_v(" "),_c('li',[_v("b. Set the person in charge of the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Task")]),_v(" to the identified person.")]),_v(" "),_c('li',[_v("c. Set the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Person")]),_v("'s task to the specified task.")])])])])])])}
},function anonymous(
) {
with(this){return _c('p',[_v("The following sequence diagram shows how an assign task operation goes through the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Model")]),_v(" component:")])}
},function anonymous(
) {
...
with(this){return _c('p',[_c('strong',[_v("Aspect: How assign task executes:")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_c('strong',[_v("Alternative 1 (current choice):")]),_v(" Saves all tasks in an additional task list.")]),_v(" "),_c('ul',[_c('li',[_v("Pros: Provides a centralized task management system independent, making it easier to track and manage tasks across different persons..")]),_v(" "),_c('li',[_v("Cons: Each task need to store additional information, such as the person in charge, leading to redundancy if not managed efficiently.")])])]),_v(" "),_c('li',[_c('p',[_c('strong',[_v("Alternative 2:")]),_v(" Add task list as a field for each person.")]),_v(" "),_c('ul',[_c('li',[_v("Pros: Easy to implement.")]),_v(" "),_c('li',[_v("Cons: Increases complexity in managing and updating task lists, especially in scenarios involving task delegation or reassignment.")])])])])}
},function anonymous(
) {
with(this){return _c('h3',{attrs:{"id":"proposed-efficiency-leaderboard"}},[_v("[Proposed] Efficiency Leaderboard"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#proposed-efficiency-leaderboard","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_v("List of unique people will be fetched and sorted based on efficiency")]),_v(" "),_c('li',[_v("Top 3/5/10 performing people will be showcased on the leaderboard")])])}
},function anonymous(
) {
...
with(this){return _c('ul',[_c('li',[_v("has a need to manage all the employees in company.")]),_v(" "),_c('li',[_v("can assign tasks to employees.")]),_v(" "),_c('li',[_v("has a need to check employees' efficiency.")]),_v(" "),_c('li',[_v("can generate a fire list to cut company costs.")]),_v(" "),_c('li',[_v("prefers smooth and eye-catching GUI.")]),_v(" "),_c('li',[_v("prefers typing to mouse interactions.")]),_v(" "),_c('li',[_v("is reasonably comfortable using CLI apps.")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Value proposition")]),_v(": EffiTrack simplifies the task of measuring and monitoring employee efficiency for\nHR departments. "),_c('br'),_v(" Instead of using time-consuming and error-prone methods like manual documentation or\noutdated systems, EffiTrack offers a centralized platform for easy and accurate monitoring of employee performance.")])}
},function anonymous(
) {
...
with(this){return _c('div',{staticClass:"table-responsive"},[_c('table',{staticClass:"markbind-table table table-bordered table-striped"},[_c('thead',[_c('tr',[_c('th',[_v("Priority")]),_v(" "),_c('th',[_v("As a …​")]),_v(" "),_c('th',[_v("I can…​")]),_v(" "),_c('th',[_v("So that I can…​")])])]),_v(" "),_c('tbody',[_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("HR Manager")]),_v(" "),_c('td',[_v("assign tasks to employees")]),_v(" "),_c('td',[_v("effortlessly assign tasks to employees, ensuring clear communication of expectations and responsibilities.")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("HR Manager")]),_v(" "),_c('td',[_v("add or remove employees")]),_v(" "),_c('td',[_v("maintain accurate and up-to-date employee records with ease.")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("HR Manager")]),_v(" "),_c('td',[_v("displays tasks with deadline within a week from now")]),_v(" "),_c('td',[_v("efficiently plan and prioritize tasks based on their urgency.")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("HR Manager")]),_v(" "),_c('td',[_v("change person in charge of a task")]),_v(" "),_c('td',[_v("easily change the person in charge of a task, ensuring smooth transition of responsibilities without disrupting workflow.")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("HR Manager")]),_v(" "),_c('td',[_v("change the deadline for an existing task")]),_v(" "),_c('td',[_v("adjust deadlines as needed to accommodate changing priorities or unforeseen circumstances without any hassle.")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("HR Manager")]),_v(" "),_c('td',[_v("set deadlines for tasks")]),_v(" "),_c('td',[_v("easily set deadlines for tasks, enabling precise scheduling and effective time management.")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("HR Manager")]),_v(" "),_c('td',[_v("assign employees to departments")]),_v(" "),_c('td',[_v("organize teams effectively and foster better collaboration.")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("HR Manager")]),_v(" "),_c('td',[_v("perform flexible searches")]),_v(" "),_c('td',[_v("obtain search results even if one character matches.")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("HR Manager")]),_v(" "),_c('td',[_v("sort the employee list based on their efficiency")]),_v(" "),_c('td',[_v("quickly sort and identify employees based on efficiency metrics, such as productivity levels, task completion rates, or performance evaluations.")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("HR Manager")]),_v(" "),_c('td',[_v("mark assigned task as done")]),_v(" "),_c('td',[_v("efficiently mark tasks as done, providing a clear indication of progress and facilitating effective task tracking and management.")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("HR Manager")]),_v(" "),_c('td',[_v("filter out poor performing employees")]),_v(" "),_c('td',[_v("identify and filter out underperforming employees based on key performance indicators, allowing for targeted intervention and support.")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("HR Manager")]),_v(" "),_c('td',[_v("set priority tags for assignments")]),_v(" "),_c('td',[_v("assign priority levels to tasks, ensuring critical tasks receive appropriate attention and resources.")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("*")])]),_v(" "),_c('td',[_v("HR Manager")]),_v(" "),_c('td',[_v("generate efficiency reports highlighting significant changes")]),_v(" "),_c('td',[_v("make informed decisions and strategic plans based on comprehensive performance insights.")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("*")])]),_v(" "),_c('td',[_v("HR Manager")]),_v(" "),_c('td',[_v("compare efficiency between departments")]),_v(" "),_c('td',[_v("identify trends, best practices, and areas for improvement.")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("*")])]),_v(" "),_c('td',[_v("HR Manager")]),_v(" "),_c('td',[_v("access a simpler interface")]),_v(" "),_c('td',[_v("navigate the system effortlessly and access key information without any complexity.")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("*")])]),_v(" "),_c('td',[_v("HR Manager")]),_v(" "),_c('td',[_v("track real time progress of assignments")]),_v(" "),_c('td',[_v("monitor the progress of assignments, facilitating timely intervention and resource allocation as necessary.")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("*")])]),_v(" "),_c('td',[_v("HR Manager")]),_v(" "),_c('td',[_v("undo and redo my commands")]),_v(" "),_c('td',[_v("easily correct mistakes or revert changes.")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("*")])]),_v(" "),_c('td',[_v("HR Manager")]),_v(" "),_c('td',[_v("view my command history")]),_v(" "),_c('td',[_v("recall commands I have executed.")])])])])])}
},function anonymous(
) {
...
with(this){return _c('p',[_c('strong',[_v("Use case: Editing a person")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("User requests to list persons")])]),_v(" "),_c('li',[_c('p',[_v("AddressBook shows a list of persons")])]),_v(" "),_c('li',[_c('p',[_v("User requests to edit a specific person in the list with the necessary edits")])]),_v(" "),_c('li',[_c('p',[_v("AddressBook edits the person")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_v("2a. The list is empty.")]),_v(" "),_c('p',[_v("Use case ends.")])]),_v(" "),_c('li',[_c('p',[_v("3a. The given index is invalid.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("3a1. AddressBook shows an error message.")]),_v(" "),_c('p',[_v("Use case resumes at step 2.")])])])]),_v(" "),_c('li',[_c('p',[_v("3b. The necessary edits are missing")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("3b1AddressBook shows an error message.")]),_v(" "),_c('p',[_v("Use case resumes at step 2")])])])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Use case: Change deadline of a task")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("User requests to list tasks")])]),_v(" "),_c('li',[_c('p',[_v("AddressBook shows a list of tasks")])]),_v(" "),_c('li',[_c('p',[_v("User requests to edit a specific task in the list with a new deadline")])]),_v(" "),_c('li',[_c('p',[_v("AddressBook edits the task")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
...
with(this){return _c('ol',[_c('li',[_c('p',[_v("User requests to list tasks")])]),_v(" "),_c('li',[_c('p',[_v("AddressBook shows a list of tasks")])]),_v(" "),_c('li',[_c('p',[_v("User requests to list persons")])]),_v(" "),_c('li',[_c('p',[_v("AddressBook shows a list of people")])]),_v(" "),_c('li',[_c('p',[_v("User requests to assign a task to a person")])]),_v(" "),_c('li',[_c('p',[_v("AddressBook assigns the task to the person")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_v("2a. The list is empty.")]),_v(" "),_c('p',[_v("Use case ends.")])]),_v(" "),_c('li',[_c('p',[_v("4a. The list is empty.")]),_v(" "),_c('p',[_v("Use case ends.")])]),_v(" "),_c('li',[_c('p',[_v("5a. The given index is invalid.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("5a1. AddressBook shows an error message.")]),_v(" "),_c('p',[_v("Use case resumes at step 4.")])])])]),_v(" "),_c('li',[_c('p',[_v("5b. The person already has a task.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("5b1 AddressBook shows an error message.")]),_v(" "),_c('p',[_v("Use case resumes at step 4.")])])])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Use case: Set priority tag for a task")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("User requests to list tasks")])]),_v(" "),_c('li',[_c('p',[_v("AddressBook shows a list of tasks")])]),_v(" "),_c('li',[_c('p',[_v("User requests tag a task with a priority status")])]),_v(" "),_c('li',[_c('p',[_v("AddressBook tags the task")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_v("2a. The list is empty.")]),_v(" "),_c('p',[_v("Use case ends.")])]),_v(" "),_c('li',[_c('p',[_v("3a. The given index is invalid.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("3a1. AddressBook shows an error message.")]),_v(" "),_c('p',[_v("Use case resumes at step 2")])])])]),_v(" "),_c('li',[_c('p',[_v("3b. The given index is invalid.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("3b1. AddressBook shows an error message.")]),_v(" "),_c('p',[_v("Use case resumes at step 2")])])])])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_v("Should work on any "),_c('em',[_v("mainstream OS")]),_v(" as long as it has Java "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("11")]),_v(" or above installed.")]),_v(" "),_c('li',[_v("Should be able to hold up to 1000 persons without a noticeable sluggishness in performance for typical usage.")]),_v(" "),_c('li',[_v("A user with above average typing speed for regular English text (i.e. not code, not system admin commands) should be able to accomplish most of the tasks faster using commands than using the mouse.")]),_v(" "),_c('li',[_v("The respond time for any action should be less than 5 seconds.")]),_v(" "),_c('li',[_v("The app should have an uptime of at least 99.5%, ensuring data accessibility for managers.")]),_v(" "),_c('li',[_v("There should be at most 2 hours of downtime in a day for maintenance or updates.")]),_v(" "),_c('li',[_v("The app should efficiently store and manage data for at least 10 years of employee history.")]),_v(" "),_c('li',[_v("There should be a daily scheduled backup of the app's data.")]),_v(" "),_c('li',[_v("The app should allow data export in at least three common formats like CSV, XLSX and PDF.")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('em',[_v("{More to be added}")])])}
},function anonymous(
...
with(this){return _c('ul',[_c('li',[_c('strong',[_v("Efficiency")]),_v(": The employee's default efficiency score is 80% and capped at 100%. Efficiency will increase by 1% when the employee completes an assigned task within the deadline and decrease by 1% for each subsequent day the deadline is exceeded.")]),_v(" "),_c('li',[_c('strong',[_v("Efficiency Threshold")]),_v(": A user-defined benchmark in the app, classifying employee performance. For instance, a threshold below 20% indicates poor performance (colour coded in red), while 21-79% suggests problematic performance requiring attention (colour coded in yellow).")]),_v(" "),_c('li',[_c('strong',[_v("Fire list")]),_v(": List of employees who are below the efficiency threshold.")]),_v(" "),_c('li',[_c('strong',[_v("Key Performance Indicators (KPIs)")]),_v(": Quantifiable measures used to evaluate the success of an employee or a department in achieving specific objectives.")]),_v(" "),_c('li',[_c('strong',[_v("Duplicate Person")]),_v(": Person of the same name.")]),_v(" "),_c('li',[_c('strong',[_v("Dupicate Task")]),_v(": Task of the same task title.")])])}
},function anonymous(
) {
...
with(this){return _c('footer',[_c('div',{staticClass:"text-center"},[_c('small',[_v("["),_c('span',[_c('strong',[_v("Powered by")])]),_v(" "),_c('img',{attrs:{"src":"https://markbind.org/favicon.ico","width":"30"}}),_v(" "),_c('a',{attrs:{"href":"https://markbind.org/"}},[_v("MarkBind 5.4.0")]),_v(", generated on Sat, 13 Apr 2024, 16:21:57 GMT+8]")])])])}
}];
